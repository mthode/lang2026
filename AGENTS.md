...
Complex new features should be planned ahead of time to ensure the design is well thought out and potential issues are identified early.  When planning a new feature, add a plan markdown document in the `plans` folder.  
